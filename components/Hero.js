...
const heroContent = {
  intro: {
    ...
    subTitle: "Welcome",
    description:
      "Welcome to a world where creativity meets unwavering structural integrity. At ArtCraft we believe that exceptional design goes hand in hand with meticulous engineering.",
    btn: {
      href: "/projects",
      label: "View Projects",
    },
